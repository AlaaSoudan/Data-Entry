...
"حمورية"
    ...
    gitems: ["متزوج(ة) ", "عازب(ة)", "مطلق(ة)  ", "منفصل(ة)","أرمل(ة)", "مخطوب(ة) "],
    knowlageitem :[
    "كلام متداول عبر الآخرين","متطوعي الوصول","موظفين عاملين لدى الشريك الذي يدير المركز المجتمعي","منظمة أخرى غير حكومية أو هيئة تابعة للأمم المتحدة","جهة حكومية","عن طريق آخر"],
    ...
    nationaltyitems:["سوري","عراقي","فلسطيني","سوداني","صومالي","فلسطيني سوري","غير ذلك"]
  }),
